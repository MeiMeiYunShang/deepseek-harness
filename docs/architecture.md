...
| [`llm/llm`](subsystems/llm-streaming.md) | Message and stream vocabulary plus the adapter seam, exposed to the web through a streaming one-shot `chat` Remote | `ctx.llm` |

...
| [host-metrics.md](host-metrics.md) | the periodic host resource sampler: CPU/memory samples emitted as forwarded `host/metrics` events for the Web console |
| [knowledge.md](knowledge.md) | the knowledge store: entries, groups, the file-backed provider, and the Remote controller |

...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  knowledgeController: 'knowledge.md',
...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  imageToText: 'client-side image-to-text capability accessor (ImageToTextService) — packages/attachment/attachment/README.md owns the API',
  workspaces: 'client-side workspace navigation adapter — packages/api/workspace-controller/README.md owns the API',
}
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  HostMetrics: 'event payload contract is owned by packages/host/host-metrics/README.md',
  KnowledgeEntry: 'knowledge record contract is owned by packages/knowledge/knowledge/README.md',
  KnowledgeEntryFilter: 'knowledge query contract is owned by packages/knowledge/knowledge/README.md',
  KnowledgeEntryId: 'knowledge identity contract is owned by packages/knowledge/knowledge/README.md',
  KnowledgeEntryInput: 'knowledge write contract is owned by packages/knowledge/knowledge/README.md',
  KnowledgeGroup: 'knowledge group contract is owned by packages/knowledge/knowledge/README.md',
  KnowledgeGroupId: 'knowledge group identity contract is owned by packages/knowledge/knowledge/README.md',
  KnowledgeGroupInput: 'knowledge group write contract is owned by packages/knowledge/knowledge/README.md',
  KnowledgeListRequest: 'knowledge controller request contract is owned by packages/api/knowledge-controller/README.md',
  KnowledgeListValue: 'knowledge controller response contract is owned by packages/api/knowledge-controller/README.md',
  KnowledgeGetValue: 'knowledge controller response contract is owned by packages/api/knowledge-controller/README.md',
  KnowledgeCreateInput: 'knowledge controller request contract is owned by packages/api/knowledge-controller/README.md',
  KnowledgeCreateValue: 'knowledge controller response contract is owned by packages/api/knowledge-controller/README.md',
  KnowledgeUpdatePatch: 'knowledge controller request contract is owned by packages/api/knowledge-controller/README.md',
  KnowledgeUpdateValue: 'knowledge controller response contract is owned by packages/api/knowledge-controller/README.md',
  KnowledgeDeleteValue: 'knowledge controller response contract is owned by packages/api/knowledge-controller/README.md',
  KnowledgeGroupCreateInput: 'knowledge controller request contract is owned by packages/api/knowledge-controller/README.md',
  KnowledgeGroupCreateValue: 'knowledge controller response contract is owned by packages/api/knowledge-controller/README.md',
  KnowledgeGroupDeleteValue: 'knowledge controller response contract is owned by packages/api/knowledge-controller/README.md',
  LlmChatChunk: 'LLM streaming chunk contract is owned by packages/llm/llm/README.md',
  LlmChatRequest: 'LLM chat request contract is owned by packages/llm/llm/README.md',
}

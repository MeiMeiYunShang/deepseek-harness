...
import * as SettingsInvariant from '@deepseek-ai/dsh-client-ui-settings-knowledge/invariant'
...
describe('invariant companion', () => {
  ...
  it('has an empty node half', async () => {
    const { apply } = await import('@deepseek-ai/dsh-client-ui-settings-knowledge')
